        ...
        return (
          <React.Fragment key={stepIndex}>
            <div className="flex flex-col items-center relative">
              <div
                className={`w-6 h-6 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? 'bg-green-500 scale-110' : isCompleted ? 'bg-green-500' : 'bg-gray-200'
                  }`}
              >
              </div>
            </div>
