...
const perks = ["משרד מפנק", "רכב חברה", "איזון בית-עבודה", "אופציות", "תנאים טובים", "עבודה היברידית", "עבודה מהבית", "שכר גבוה", "בונוסים", "תקציב התפתחות", "דלקן", "הגנת שכר", "נופשי חברה בחו״ל", "ימי גיבוש", "מתנות לחגים", "הכשרה על חשבון החברה", "משכורת 13 שנתית", "עובד/ת חברה", "סיבוס", "תן ביס", "גמישות בשעות העבודה", "קרן השתלמות", "ביטוח בריאות", "אווירה צעירה"];
