            ...
            <CardContent className="p-6">
                <div className="flex justify-between items-start gap-6">
                    ...
                    <div className="flex flex-col gap-3 items-center">
                        ...
                        <Button
                            asChild
                            className={`text-white px-6 py-2 rounded-full font-bold shadow-sm transition-colors duration-300 ${job.match_score >= 70 ? 'bg-green-400 hover:bg-green-500' : job.match_score >= 40 ? 'bg-orange-400 hover:bg-orange-500' : 'bg-red-500 hover:bg-red-600'
                                }`}
                        >
                            <Link
