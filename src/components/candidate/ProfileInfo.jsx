...
const ProfileInfo = ({ looking_for_summary, bio, aiThoughts, aiSummary, isLoading }) => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full text-right" dir="rtl">
        <div className="bg-white p-4 rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border border-gray-100 flex flex-col items-start h-full" dir="rtl">
            ...
            <div className="text-gray-600 text-sm leading-relaxed whitespace-pre-line w-full text-right">
                {isLoading ? (
                    ...
                    <ul className="list-disc list-inside space-y-2 marker:text-blue-500 w-full text-right" dir="rtl">
