...
const EmailConfirmation = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#dbecf3] from-[12.35%] to-[#ffffff] via-[#ffffff] via-[32.336%] min-h-screen flex items-center justify-center p-4" data-name="אימות מייל הרשמה" data-node-id="418:1596">
      {/* Background Card */}
